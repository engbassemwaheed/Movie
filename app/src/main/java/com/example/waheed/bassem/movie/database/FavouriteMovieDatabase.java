 ...
 */
public class FavouriteMovieDatabase extends Model {
    @Column (name = "MovieId")
     ...
     */
    public FavouriteMovieDatabase(String movieId, String name, String averageVote, String releaseDate,
