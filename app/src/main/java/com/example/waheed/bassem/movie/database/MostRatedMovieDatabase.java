 ...
 */
public class MostRatedMovieDatabase extends Model {
    @Column (name = "MovieId")
     ...
     */
    public MostRatedMovieDatabase(String movieId, String name, String averageVote, String releaseDate,
